...
main:  Common.o Assembler.o Input.o main.o Stack.o DisAssembler.o StrFunctions.o Processor.o JmpComparators.o Proc_Init_Destroy.o GraphicalInterface.o
	$(CC) $(linker_flags) Common.o Assembler.o Input.o main.o Stack.o DisAssembler.o StrFunctions.o Processor.o JmpComparators.o Proc_Init_Destroy.o GraphicalInterface.o -lm -lncursesw
...
Stack.o: ../Stack/Stack.c
	$(CC) -c $(CFLAGS) ../Stack/Stack.c

Input.o: ../EvgeniyOnegin/Input.c
	$(CC) -c $(CFLAGS) ../EvgeniyOnegin/Input.c
